<a name="store-deletion-service"></a>
...
- [StoreDeletionService.java](https://github.com/dacruuz/books-change-api/blob/documentation/issue-59-documentacao-api/src/main/java/br/com/bookschange/api/application/store/services/StoreDeletionService.java)
